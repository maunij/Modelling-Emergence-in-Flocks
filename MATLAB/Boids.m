...
%         end
    ...
    % Cohesion, move unit distance towards the centre of the flock
    for i = 1:N
...
%
% These boundary conditions create a milling phenomenon.
% 
%     for i = 1:N
%         c = zeros(1,2);
%         if x(i,1) > xMax
...
%     end
% 
% Standard boundary conditions, keep boids on the square
%
%     for i = 1:N
%         c = zeros(1,2);
%         if x(i,1) > xMax
